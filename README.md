...
**Верстка** :
- [F & B — Коллекция природных артефактов](https://ryabovaev.github.io/NaturalArtifacts/): F & B — это интерактивный сайт-галерея, посвящённый природным артефактам. Проект реализован с помощью сборщика vite c акцентом на визуальное восприятие, адаптивную верстку и высокую производительность.
