...
**Верстка** :
- [F & B — Коллекция природных артефактов](https://ryabovaev.github.io/NaturalArtifacts/): F & B — это интерактивный сайт-галерея, посвящённый природным артефактам. Проект реализован с помощью сборщика vite, нейминг по БЭМ, добавлены теги SEO, настроена высокая доступность (accessibility), адаптивный контент, для слайдера использовала бибилиотеку swiper.
